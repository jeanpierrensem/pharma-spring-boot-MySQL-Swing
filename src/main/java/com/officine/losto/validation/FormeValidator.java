...
@Component
public class FormeValidator extends ValidationSupport implements Validator<Forme> {

	@Override
	public Optional<ValidationError> validate(Forme forme ) {
		if (isNullOrEmptyString(forme.getFormeName()))
		{
			return Optional
