...
@Component
public class TypeValidator extends ValidationSupport implements Validator<Typpe> {

	@Override
	public Optional<ValidationError> validate(Typpe type) {
		if (isNullOrEmptyString(type.getTyppeName()))
		{
			return Optional
