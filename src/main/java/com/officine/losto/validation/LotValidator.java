...
@Component
public class LotValidator extends ValidationSupport implements Validator<Lot> {

	@Override
	public Optional<ValidationError> validate(Lot lot ) {
		if (isValueLessThanZero(lot.getQuantiteLot()))
