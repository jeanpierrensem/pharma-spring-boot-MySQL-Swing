...
@Getter
public class CategorieFrame extends JDialog {
	...
	public CategorieFrame(CategorieTableModel tableModel) {
		//setUndecorated(false);
	
		
		initComponents();
		//Shared.setFrameUp(MainMenuFrame.ctrl.categorieFrame, this);
	...
	private void initComponents() {
		setTitle( ConstMessagesEN.DialogTitles.CATEGORIE_MODAL);
		setResizable(true);
		...
		FormJPanel.setBorder(new EtchedBorder(EtchedBorder.RAISED, null, null));
		...
		jLabel1.setFont(new Font(ConstMessagesEN.Params.POLICE_TYPE, Font.BOLD, 11));
		jLabel2 = new javax.swing.JLabel();
		jLabel2.setForeground(Color.DARK_GRAY);
		jLabel2.setFont(new Font(ConstMessagesEN.Params.POLICE_TYPE, Font.BOLD, 11));
		jLabel3 = new javax.swing.JLabel();
		jLabel3.setForeground(Color.DARK_GRAY);
		jLabel3.setFont(new Font(ConstMessagesEN.Params.POLICE_TYPE, Font.BOLD, 11));
		...
		jLabel2.setText("Désignation Catégorie");

		jLabel3.setText("Description Catégorie");
						...
						.addGroup(gl_FormJPanel.createSequentialGroup()
							...
							.addGroup(gl_FormJPanel.createParallelGroup(Alignment.TRAILING)
								.addGroup(gl_FormJPanel.createSequentialGroup()
									...
									.addComponent(tb_libelle, GroupLayout.DEFAULT_SIZE, 97, Short.MAX_VALUE))
								.addComponent(tb_code, GroupLayout.PREFERRED_SIZE, 120, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_FormJPanel.createSequentialGroup()
							.addComponent(jLabel3)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(tb_description, GroupLayout.DEFAULT_SIZE, 123, Short.MAX_VALUE)))
					.addGap(20))
		);
		gl_FormJPanel.setVerticalGroup(
			gl_FormJPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_FormJPanel.createSequentialGroup()
					...
					.addGroup(gl_FormJPanel.createParallelGroup(Alignment.BASELINE)
						.addComponent(jLabel3)
						.addComponent(tb_description, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE))
	...
	public Categorie getMenuFromForm() {
		Categorie Categorie = new Categorie(); 
		Categorie.setCategorieName(tb_libelle.getText().trim());
		Categorie.setCategorieDescription(tb_description.getText().trim());
		if (! tb_code.getText().trim().equalsIgnoreCase(Strings.EMPTY))
			Categorie.setId(Long.parseLong(tb_code.getText().trim()));	
	...
	public void loadSelectedRow(CategorieTableModel tableModel) {
