...
@Getter
public class RayonFrame extends JDialog {
	...
	public RayonFrame(RayonTableModel tableModel) {
	...
	private void initComponents() {
		...
		setTitle( ConstMessagesEN.DialogTitles.RAYON_MODAL);
		setResizable(true);
		...
		jLabel2.setText("Désignation rayon");

		jLabel3.setText("Description rayon");
				...
				.addGroup(gl_FormJPanel.createSequentialGroup()
					...
					.addGroup(gl_FormJPanel.createParallelGroup(Alignment.LEADING, false)
						.addGroup(gl_FormJPanel.createSequentialGroup()
							...
							.addComponent(tb_description, GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
							.addPreferredGap(ComponentPlacement.RELATED))
						.addGroup(gl_FormJPanel.createSequentialGroup()
							...
							.addGroup(gl_FormJPanel.createParallelGroup(Alignment.LEADING, false)
								.addGroup(gl_FormJPanel.createSequentialGroup()
									...
									.addComponent(tb_libelle, GroupLayout.PREFERRED_SIZE, 113, GroupLayout.PREFERRED_SIZE))
	...
	public Rayon getMenuFromForm() {
		Rayon rayon = new Rayon(); 
		rayon.setRayonName(tb_libelle.getText().trim());
		rayon.setRayonDescription(tb_description.getText().trim());
		if (! tb_code.getText().trim().equalsIgnoreCase(Strings.EMPTY))
			rayon.setId(Long.parseLong(tb_code.getText().trim()));	
	...
	public void loadSelectedRow(RayonTableModel tableModel) {
