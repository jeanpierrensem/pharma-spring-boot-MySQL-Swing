...
@Getter
public class FournisseurFrame extends JDialog {
	...
	public FournisseurFrame(FournisseurTableModel tableModel) {
		// setBorder(new TitledBorder(new TitledBorder(new
		// EtchedBorder(EtchedBorder.LOWERED, null, null), "Gestion Des Fournisseurs",
		// TitledBorder.TRAILING, TitledBorder.TOP, null, new Color(255, 255, 255)),
		// "Gestion Des Fournisseurs", TitledBorder.TRAILING, TitledBorder.TOP, null,
		// new Color(255, 255, 255)));
		initComponents();
		// Shared.setFrameUp(MainMenuFrame.ctrl.fournisseurFrame, this);
	...
	private void initComponents() {
		...
		gl_FormJPanel
				.setHorizontalGroup(
						gl_FormJPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_FormJPanel
								.createSequentialGroup().addContainerGap().addGroup(gl_FormJPanel
										.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_FormJPanel.createSequentialGroup().addComponent(jLabel1)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(jLabel2_3, GroupLayout.PREFERRED_SIZE, 17,
														GroupLayout.PREFERRED_SIZE)
												.addGap(6)
												.addComponent(tb_code, GroupLayout.DEFAULT_SIZE, 121, Short.MAX_VALUE))
										.addGroup(gl_FormJPanel.createSequentialGroup().addComponent(jLabel3)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(tb_description, GroupLayout.DEFAULT_SIZE, 200,
														Short.MAX_VALUE)
												.addPreferredGap(ComponentPlacement.RELATED))
										.addGroup(gl_FormJPanel.createSequentialGroup().addComponent(jLabel2)
												.addPreferredGap(ComponentPlacement.RELATED).addComponent(jLabel2_1)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(tb_libelle, GroupLayout.DEFAULT_SIZE, 134,
														Short.MAX_VALUE)
												.addPreferredGap(ComponentPlacement.RELATED)))
								.addGap(2)));
		gl_FormJPanel.setVerticalGroup(gl_FormJPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_FormJPanel.createSequentialGroup().addContainerGap()
						.addGroup(gl_FormJPanel.createParallelGroup(Alignment.BASELINE).addComponent(jLabel1)
								.addComponent(jLabel2_3).addComponent(tb_code, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(14)
						.addGroup(gl_FormJPanel.createParallelGroup(Alignment.BASELINE).addComponent(jLabel2)
								.addComponent(jLabel2_1).addComponent(tb_libelle, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addGap(28)
						.addGroup(gl_FormJPanel.createParallelGroup(Alignment.BASELINE).addComponent(jLabel3)
								.addComponent(tb_description, GroupLayout.PREFERRED_SIZE, 86,
										GroupLayout.PREFERRED_SIZE))
	...
	public Fournisseur getFournisseurFromForm() {
		Fournisseur fournisseur = new Fournisseur();
		fournisseur.setFournisseurName(tb_libelle.getText().trim());
		fournisseur.setFournisseurAdresse(tb_description.getText().trim());
		if (!tb_code.getText().trim().equalsIgnoreCase(Strings.EMPTY))
			fournisseur.setId(Long.parseLong(tb_code.getText().trim()));
	...
	public void loadSelectedRow(FournisseurTableModel tableModel) {
